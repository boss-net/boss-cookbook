...
from policies import bfSixteen, fpSixteen,bfSixteen_mixed, get_boss_wrapper
...
def set_tokenizer_params(tokenizer: BossTokenizer):
...
def get_policies(cfg, rank):
    ...
    wrapping_policy = get_boss_wrapper()
